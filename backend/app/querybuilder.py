...
SOURCES = {
    ...
    "production": {
        "label": "Production test records",
        "from": "test_records",
        "fields": {
            "ts":             {"col": "ts", "type": "timestamp", "label": "Test time"},
            "product":        {"col": "product", "type": "text", "label": "Product"},
            "part_number":    {"col": "part_number", "type": "text", "label": "Part number"},
            "serial_number":  {"col": "serial_number", "type": "text", "label": "Serial number"},
            "station":        {"col": "station", "type": "text", "label": "Station"},
            "fixture":        {"col": "fixture", "type": "text", "label": "Fixture"},
            "operator":       {"col": "operator", "type": "text", "label": "Operator"},
            "test_parameter": {"col": "test_parameter", "type": "enum", "label": "Test parameter",
                               "values": ["Pack Voltage", "Capacity (Ah)", "Cell Balance (mV)",
                                          "Insulation (MOhm)", "Charge Cycle (%)"]},
            "result":         {"col": "result", "type": "enum", "label": "Result",
                               "values": ["Pass", "Fail"]},
            "measured_value": {"col": "measured_value", "type": "number", "label": "Measured value"},
            "failure_reason": {"col": "failure_reason", "type": "text", "label": "Failure reason"},
        },
        "default_sort": {"field": "ts", "dir": "desc"},
    },
    "daily_report": {
